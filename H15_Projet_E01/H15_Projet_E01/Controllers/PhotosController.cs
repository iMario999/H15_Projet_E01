...
namespace H15_Projet_E01.Controllers
{
    public class PhotosController : Controller
    {
        ...
        {
            return View(unitOfWork.PhotoRepository.GetPhotos().ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "PhotoID,SeanceID")] Photo photo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PhotoID,SeanceID")] Photo photo)
        {
            if (ModelState.IsValid)
            {
